---
title: The economy of knowledge within an organisation
date: '2023-03-25'
...
images: ['/static/images/road-knowledge.jpg']
---
...
1. _Knowledge exchanges are flows, and thus time-dependent, unlike property exchanges._
2. _Knowledge exchanges are positive sum, unlike material exchanges._
3. _Combinations of knowledge are non-linear._
...
Investing in knowledge sharing practices is highly beneficial for organisations. It leads to higher organisational performance, innovation, skill development, and creates a fulfilling work environment where members feel valued and motivated. The scientific community is both maturing and relatively unanimous on the subject (Meta-analysis [1](https://psycnet.apa.org/record/2009-02898-017), [2](https://aisel.aisnet.org/cgi/viewcontent.cgi?article=1058&context=pajais), [3](https://www.emerald.com/insight/content/doi/10.1108/JKM-08-2013-0316/full/html)). This [extensive study](http://repo.uum.edu.my/id/eprint/16360/1/15.pdf) describes the peculiar characteristics of knowledge within the org
...
The impact of cultural context on knowledge transfer has also been studied in length, the meta-analysis **[Meta-analytic comparison on the influencing factors of knowledge transfer in different cultural contexts](https://www.emerald.com/insight/content/doi/10.1108/JKM-08-2013-0316/full/html)** states

<div class="rounded-lg bg-clip-padding p-4 pl-6 pr-6 bg-blue-700/[.09] border-4 border-blue-400">
  <p>
    *The results of the meta-analysis of the influencing factors of knowledge transfer are
    consistent with the results obtained in most previous studies, indicating a maturation of
