---
title: Defining a reliability strategy (Part 1)
date: '2022-12-27'
...
### The art of dancing in the flames
...
For the tad bit of history, the philosophy of quality assurance embedded in the production process directly is something that was popularised by [Toyota and their “Jidoka”,](https://global.toyota/en/company/vision-and-philosophy/production-system/) (part of the LEAN philosophy which I believe comes from Toyota as well) which aim to produce quality products while maintaining the pace (or in the assembly game, “[Takt time](https://en.wikipedia.org/wiki/Takt_time)”).

In the context of software development, in-production reliability is about **observability, effective incident response and active retrospection from incidents**;
...
- [https://lethain.com/incident-response-programs-and-your-startup/](https://lethain.com/incident-response-programs-and-your-startup/)
